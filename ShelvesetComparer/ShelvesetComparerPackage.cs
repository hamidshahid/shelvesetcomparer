// <copyright file="ShelvesetComparerPackage.cs" company="https://github.com/rajeevboobna/shelvesetcomparer">Copyright https://github.com/rajeevboobna/shelvesetcomparer. All Rights Reserved. This code released under the terms of the Microsoft Public License (MS-PL, http://opensource.org/licenses/ms-pl.html.) This is sample code only, do not use in production environments.</copyright>
namespace ShelvesetComparer
{
    ...
    public sealed class ShelvesetComparerPackage : Package
    {
        ...
        {
            base.Initialize();            
            ShelvesetCompare.Initialize(this);
        }
